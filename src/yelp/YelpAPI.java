...
public class YelpAPI {
    ...
    private static final String CLIENT_ID = "FTVUw-O0Pc2hxyDwAEURbg";
    private static final String CLIENT_SECRET = "fnltGdJiiKwqMhAbyASTU3MWoP46woO1vy3cBfcAcH5MQ6kUtkkaCGI3bvtiDPCe";
